                                    ...
                                    <div align="center">
                                        <select class="listMenu" name="ed001" id="ed001">
                                            ...
                                            while ($row = mysql_fetch_array($exam)) {
                                                ...
                                                ?>
                                                <option
                                                    value="<?php echo $row["desc"]; ?>"><?php echo $row["desc"] ?></option>
                                                <?php
                                ...
                                <td colspan="6"><font color="#000033"><strong><font size="2"
                                    ...
                                    <table id="expComputer" width="100%" height="34" border="1" cellpadding="0"
                                        ...
                                        <tr bgcolor="#CCFFFF">
                                            ...
                                            <td width="27%" class="tablecontent1">
                                                <div align="center">
                                                    <p><strong><font color="#0000CC" size="2"
                                            ...
                                            <td width="13%" align="center" valign="middle" class="tablecontent1">
                                                <div align="center">
                                                    <p><strong><font color="#0000CC" size="2"
                                                                     face="Arial, Helvetica, sans-serif">Course duration
                                                                (Month)</font></strong></p>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <font color="#000033" size="2">
                                            <strong>
                                                <label for="accp_decl">
                                                    ...
                                                    of eligibility. I also declare that I have applied only for one
                                                    Block post in the district and if any time it is found that i have
                                                    applied more than one Block my candidature is liable to canceled. I
                                                    certify that the information given in the
