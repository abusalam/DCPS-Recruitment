        ...
        <tr>
          <td height="300" valign="top"><table align="center" border="0" cellpadding="0" cellspacing="0" width="687">
            ...
            <tr>
                    ...
                    <td class="header" bgcolor="#e9fafe" width="256">Add Photograph 
                      & Signature</td>
              <td width="28"><img src="image/h_cut.gif" height="27" width="28"></td>
              <td class="header" align="right" width="394">&nbsp;</td>
            </tr>
            <tr>
                            ...
                            <tbody>
                              ...
                              <tr> 
                                <td class="tablecontent1" align="left" valign="top">Upload 
                                  Signature <span class="alert">*</span>:</td>
                                <td class="tablecontent1" align="left" valign="top"> 
                                  <input name="userfile1" id="userfile1" type="file" size="50" value=""> 
                                </td>
                              </tr>
                            
                              <tr> 
                                <td colspan="2" class="tablecontent2" valign="top"><table align="center" border="0" cellpadding="2" cellspacing="2" width="223">
                                    
                                      <tr> 
                                        <td align="center" height="25" width="85"><input value="Continue" name="Submit" class="button" id="subbtn" type="submit"></td>
                                        <td align="center" width="121"><input value="Reset" name="Reset" class="button" onClick="document.login_frm.reset();" type="reset"></td>
                                        <td align="center" width="94"><input onClick="javascript:window.close();" value="Close" name="Submit3" class="button" type="button"> 
                                        </td>
                                      </tr>
