...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          <td height="300" valign="top"><table align="center" border="0" cellpadding="0" cellspacing="0" width="750">
            <tbody><tr>
                  ...
                  <tbody>
                    ...
                    <tr> 
                      ...
                      <td class="tablecontent1" align="left" valign="middle"> 
                        <a class="disability" href="#" onClick="javascript:mypopup('Application_entry.php','600','700')">Apply 
                        Online</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
					 ...
					 <tr> 
                      <td class="tablecontent1" align="center" valign="middle" width="25"><img src="image/bullet1.gif" height="11" width="7"></td>
                      <td class="tablecontent1" align="left" valign="middle"> 
                        <a class="disability" href="#" onClick="javascript:mypopup('Add_image.php','600','700')">Add 
                        Photo & Signature </a></td>
                    </tr>
                    <tr> 
                      <td class="tablecontent1" align="center" valign="middle" width="25"><img src="image/bullet1.gif" height="11" width="7"></td>
                      <td class="tablecontent1" align="left" valign="middle"> 
                        <a class="disability" href="#" onClick="javascript:mypopup('Application_Reprint.php','600','700')">Application 
                        Reprint </a></td>
                    </tr>
                    <tr> 
                    ...
                    <td class="personaldetails">:</td>
                    <td align="left" class="personaldetails">30/01/2013</td>
                  </tr> -->
                            <!-- <tr>
                    <td align="left" class="personaldetails">Last Date for Fee deposit</td>
                    <td class="personaldetails">:</td>
                    ...
                    <tr> 
                      ...
                      <td align="left" valign="middle" bgcolor="#D6D6D6" class="tablecontent1"><span class="redtext">Disclaimer</span>:</td>
                    </tr>
                    <tr> 
                      <td class="tablecontent1" align="left" valign="middle">&nbsp;</td>
                      <td class="tablecontent1" align="left" valign="middle">On-Line 
                        Application validation rules are designed based on the 
                    ...
                    <tr> 
                      <td height="52" align="center" valign="middle" class="tablecontent1">&nbsp;</td>
