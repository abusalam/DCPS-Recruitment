...
var post = {'01' : 'Dy.General Manager (Integrated Treasury) TEG SC-VI',
...
quote[k]="opt_cat,category_name_db,radiobutton,1";k=funcadd(k);
quote[k]="optdisability,disability_db,radiobutton,2";k=funcadd(k);
quote[k]="seldisabilitytype,disability_type_db,dropdown,3";k=funcadd(k);
quote[k]="seldisabilityper,disability_per_db,dropdown,4";k=funcadd(k);
quote[k]="optscribe,scribe_db,radiobutton,5";k=funcadd(k);
quote[k]="txtcatcode,cat_code_db,textbox,250";k=funcadd(k);
//quote[k]="riots,riots_db,radiobutton,6";k=funcadd(k);
quote[k]="optkashmir,state_jk_db,radiobutton,7";k=funcadd(k);

quote[k]="optminority,minority_db,radiobutton,8";k=funcadd(k);
quote[k]="selminority,religion_db,dropdown,9";k=funcadd(k);
...
quote[k]="optexservice,exserviceman_db,radiobutton,13";k=funcadd(k);
//quote[k]="optdisxs,optdisxs_db,radiobutton,14";k=funcadd(k);
quote[k]="txt_exser_no,ex_ser_per_db,textbox,15";k=funcadd(k);
...
quote[k]="selstateapplied,state_code_db,dropdown,19";k=funcadd(k);
quote[k]="selexamcentre,centre_code_db,dropdown,20";k=funcadd(k);

quote[k]="optpet,training_db,radiobutton,22";k=funcadd(k);
quote[k]="selpetcentre,training_centre_db,dropdown,23";k=funcadd(k);

quote[k]="paymentin,payment_mode_db,radiobutton,24";k=funcadd(k);
quote[k]="txtfee,fee_db,textbox,25";k=funcadd(k);

quote[k]="fullname,fullname_db,textbox,41";k=funcadd(k);
//quote[k]="middlename,middlename_db,textbox,65";k=funcadd(k);
//quote[k]="txtlastname,lastname_db,textbox,66";k=funcadd(k);
quote[k]="seldobyear,seldobmon,seldobday,dob_db,dobcompare,43";k=funcadd(k);
quote[k]="txtage,age_db,textbox,44";k=funcadd(k);
quote[k]="optsex,gender_db,radiobutton,45";k=funcadd(k);
quote[k]="txtfname,father_name_db,textbox,46";k=funcadd(k);
quote[k]="txtmname,mother_name_db,textbox,47";k=funcadd(k);
...
quote[k]="txtcemail,mail_id_db,textbox,48";k=funcadd(k);
quote[k]="txtaddress1,address1_db,textbox,49";k=funcadd(k);
quote[k]="txtaddress2,address2_db,textbox,50";k=funcadd(k);
quote[k]="txtaddress3,address3_db,textbox,51";k=funcadd(k);	
quote[k]="txtdistrict,district_db,textbox,52";k=funcadd(k);
quote[k]="txtstate,state_db,dropdown,53";k=funcadd(k);
quote[k]="txtpin,pincode_db,textbox,54";k=funcadd(k);
quote[k]="txtaddress1perm,addressp1_db,textbox,56";k=funcadd(k);
quote[k]="txtaddress2perm,addressp2_db,textbox,57";k=funcadd(k);
quote[k]="txtaddress3perm,addressp3_db,textbox,58";k=funcadd(k);	
quote[k]="txtdistrictp,districtp_db,textbox,59";k=funcadd(k);
quote[k]="txtstateperm,statep_db,dropdown,60";k=funcadd(k);
quote[k]="txtpinperm,pincodep_db,textbox,61";k=funcadd(k);
quote[k]="txtstd,std_db,textbox,62";k=funcadd(k);
quote[k]="txtphone,phone_db,textbox,63";k=funcadd(k);
quote[k]="txtmobile,mobile_db,textbox,64";k=funcadd(k);

quote[k]="selstream3,graduationsubjects_db,textbox,67";k=funcadd(k);
...
quote[k]="selyr3,graduationpassingyear_db,textbox,70";k=funcadd(k);
quote[k]="selmark3,graduationpercentage_db,percentage,71";k=funcadd(k);
//quote[k]="selgrade3,graduationgrade_db,dropdown,52";k=funcadd(k);

quote[k]="selstream4,pgsubjects_db,textbox,73";k=funcadd(k);
//quote[k]="selday4,pgpassingdate_db,dropdown,54";k=funcadd(k);
//quote[k]="selmon4,pgpassingmon_db,dropdown,55";k=funcadd(k);
quote[k]="selyr4,pgpassingyear_db,dropdown,76";k=funcadd(k);
quote[k]="selmark4,pgpercentage_db,percentage,77";k=funcadd(k);
//quote[k]="selgrade4,pggrade_db,dropdown,58";k=funcadd(k);

quote[k]="selstream6,profsubjects_db,textbox,79";k=funcadd(k);
//quote[k]="selday6,profpassingdate_db,dropdown,60";k=funcadd(k);
//quote[k]="selmon6,profpassingmon_db,dropdown,61";k=funcadd(k);
quote[k]="selyr6,profpassingyear_db,dropdown,82";k=funcadd(k);
quote[k]="selmark6,profpercentage_db,percentage,83";k=funcadd(k);
...
quote[k]="radio_dip,diploma_type_db,radiobutton,251";k=funcadd(k);
quote[k]="selstream8,diplomasubjects_db,textbox,211";k=funcadd(k);
...
quote[k]="selyr8,diplomapassingyear_db,dropdown,214";k=funcadd(k);
quote[k]="selmark8,diplomapercentage_db,percentage,215";k=funcadd(k);
...
if(postcode !="")
{
	...
	if(postcode=="17")
	{
			var petexamcenterlist = {'01':'Navi Mumbai',
'02':'Noida',
'03':'Pune',
'04':'Bhopal',
'05':'Kolkata',
