    ...
    <div class="tdbg" style="width: 700px;">
        <form name="admitcard" method="POST" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>>
            ...
            <table align="center" cellpadding="0" cellspacing="0" bordercolor="#333333">
                ...
                <tr bgcolor="#EEF7FD">
                    <td height="42" colspan="2">
                        <div style="text-align: center;font-size: 18px;color: #6D7F04;">
                            <h2>Search Your Admit Card Using Date of Birth</h2>
                        </div>
                    </td>
                </tr>
                ...
                <tr bordercolor="#000099" bgcolor="#FFFFCC">
                    <td width="351" height="34" bordercolor="#000099" bgcolor="#FFFFFF">
                        <div align="center"><strong></strong></div>
                        <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong>DATE OF
                                    BIRTH</strong></font></div>
                    </td>
                    <td width="360" bordercolor="#000099" bgcolor="#FFFFFF">
                        <div align="left">
                            <input name="dob" size="10" maxlength="10" type="text"
                                   value= <?php echo htmlspecialchars($row['dob']); ?>>
                            <strong><font color="#FF0000" size="2">(DD-MM-YYYY)</font></strong></div>
                    </td>
                </tr>
                <tr bgcolor="#FFFFFF">
            ...
            if ($value) {
                ?>
                <hr/>
                <table border="1" rules="all" align="center" cellpadding="4" cellspacing="0" bordercolor="#7a51ff">
                    <tr>
                        <th colspan="4">
                            <div style="text-align: center;color: #6D7F04;">
                    ...
                    while ($row = mysql_fetch_array($value)) {
                        ?>
                        <tr bordercolor="#000099" bgcolor="#FFFFCC">
                            <td height="35" bordercolor="#666666" bgcolor="#FFFFFF">
                                <div align="center"><strong><font color="#003399" size="2"
                                                                  face="Verdana, Arial, Helvetica, sans-serif">
                                            <a href="PrintAdmitCard.php?examroll=<?php echo $row["examroll"]; ?>"
                                               target="_blank">
                                                <?php echo $row["aname"]; ?></a></font></strong></div>
                            </td>
                            <td bordercolor="#666666" bgcolor="#FFFFFF">
                                <div align="center"><strong><font color="#003399" size="2"
                                                                  face="Verdana, Arial, Helvetica, sans-serif">
                                            <?php echo $row["father"]; ?> </font></strong></div>
                            </td>
                            <td bordercolor="#666666" bgcolor="#FFFFFF">
                                <div align="center"><strong><font color="#003399" size="2"
                                                                  face="Verdana, Arial, Helvetica, sans-serif">
                                            <?php echo $row["mobile"]; ?> </font></strong></div>
                            </td>
                            <td bordercolor="#666666" bgcolor="#FFFFFF">
                                <div align="center"><strong><font color="#003399" size="2"
                                                                  face="Verdana, Arial, Helvetica, sans-serif">
                                            <?php echo date("d-m-Y", strtotime($row["dob"])); ?> </font></strong></div>
                            </td>
                        </tr>
                        <?php
                    }
                ...
                <tr>
                    ...
                    <td height="62" bgcolor="#EEF7FD">
                        <div align="center">
                            ...
                            <p align="center">
                                <small>
                                    <small><font face="Arial, Helvetica, sans-serif" color="#003399" size="2"><strong>Designed
                                            ...
                                            <font color="#003399" size="2" face="Arial, Helvetica, sans-serif">Paschim
                                                Medinipur</font></strong></small>
                                    <strong><font color="#003399" size="2" face="Arial, Helvetica, sans-serif">
                                            <small><font size="2">
                                                    District Unit, West Bengal.<br>
                                                    Contents provided by District Administration, </font>
                                                <small>
                                                    <font size="2">Paschim</font><font size="2"> Medinipur District
                                                    </font></small>
                                                <font size="2">,West Bengal</font></small>
                                        </font></strong>
                            </p>
                        </div>
                    </td>
