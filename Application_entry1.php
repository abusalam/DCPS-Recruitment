...
<DIV align="left">
    ...
    <table width="100%" height="977">
      ...
      <tr bgcolor="#CCFFFF">
        <TD  class="tablecontent1"height="41" colspan="6"><div align="center"></div></TD>
         
      </tr>
      <tr> 
        <td width="144" height="2"> 
      <tr> 
        <td class="tablecontent1" width="144" height="34"> <div align="left"><font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif">Name 
            <font color="#CC0000">*</font>:</font></strong></font></div></td>
        <td colspan="2" class="tablecontent1"><div align="left"><font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif"> 
            <input name="name" id = "name" type="text" size="25" value="">
            <br>
            </font></strong></font></div></td>
        <td class="tablecontent1" width="404"><div align="left"><font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif">Father's/Husband's 
      ...
      <tr> 
        <td class="tablecontent1" height="36"> <div align="left"><font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif">Nationality</font><font size="2" face="Arial, Helvetica, sans-serif"><font color="#FF0000">*</font>:</font></strong></font></div></td>
        <td colspan="2" class="tablecontent1"><div align="left"><font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif"> 
            <input name="nationality" readonly  type="text" size="6" value="Indian" >
            &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; 
            &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;</font></strong></font></div></td>
        <td class="tablecontent1"><div align="left"><font color="#000033" size="2" face="Arial, Helvetica, sans-serif"><strong>Gender<font color="#FF0000">*</font>:</strong></font> <strong><font color="#FFFF00" size="5" face="Monotype Corsiva"><em><font color="#3399CC">
	...
	?>
        ...
        </font></font></strong></div></td><td class="tablecontent1" colspan="2"> </td>
      </tr>
      <tr>
        <td height="32" align="left" class="tablecontent1"><div align="left"><font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif">Category<font color="#FF0000">*</font>:</font></strong></font></div></td>
        <td width="154" align="left" class="tablecontent1"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#000033">
          <select class="category" name="category" id = "category" onChange="getYearList();" >
        ...
        </select></font></strong></font></div></td>
        <td width="184" class="tablecontent1"><div><font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif">Date 
            Of Birth<font color="#FF0000">*</font>:</font></strong></font></div></td>
        <td class="tablecontent1"><div><font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif"><select class="listMenu" size="1" name="seldobday" id="seldobday" onChange="setAge()">
        ...
        <td colspan="2" class="tablecontent1"><font size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#000033">Age 
      ...
      <tr> 
        ...
        <td colspan="2" class="tablecontent1"><font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif">
        ...
        <td colspan="2" class="tablecontent1"><font color="#000033"><strong><font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif">
          <input name="phone" type="text" id = "phone" value="" size="10" maxlength="10" >
        </font></strong></font></strong></font></td>
      </tr>
      <tr> 
        <td class="tablecontent1" height="123" valign="middle"> <div align="left"><font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif">Present 
            Address<font color="#FF0000">*</font></font></strong></font>:</div></td>
        <td colspan="2" class="tablecontent1"><table width="87%" height="89" border="0">
            <tr> 
            ...
            <tr>
              ...
              <td><select class="listMenu" name="block1" id = "block1" >
				...
				{
					?>
                        <option value="<?php echo $row["block_muni_nm"]; ?>"><?php echo $row["block_muni_nm"] ?></option>
                        <?php
	...
	?>
            ...
            <tr> 
              ...
              <td><select class="listMenu" name="sub1" id = "sub1" >
				...
				{
					?>
                        <option value="<?php echo $row["subdiv"]; ?>"><?php echo $row["subdiv"] ?></option>
                        <?php
	...
	?>
            ...
            <tr> 
              <td width="29%"><font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif">Pin<font color="#FF0000">*</font></font></strong></font>:</td>
	...
	?>
        ...
        <td valign="middle" class="tablecontent1"> <div align="left"><font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif">Permanent</font><font size="2" face="Arial, Helvetica, sans-serif"> 
            Address<font color="#FF0000">*</font>:</font></strong></font></div></td>
        <td colspan="2" class="tablecontent1"><table width="100%" border="0">
            <tr> 
              <td width="29%"><font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif">Village/City/Road/Post Office<font color="#FF0000">*</font></font></strong></font>:</td>
	...
	?>
      ...
      <tr> 
        <td class="tablecontent1" height="24" colspan="5"><font color="#000033" size="2" face="Arial, Helvetica, sans-serif"><strong>Whether 
      ...
      <tr> 
        <td height="163" colspan="6" > <font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif"> 
            ...
            <tr bgcolor="#CCFFFF"> 
              <td class="tablecontent1"> <div align="center"><font color="#0000CC"><strong><font size="2" face="Arial, Helvetica, sans-serif">Qualification</font></strong></font></div></td>
              <td width="19%" class="tablecontent1"> <div align="center"><font color="#0000CC"><strong><font size="2" face="Arial, Helvetica, sans-serif">Name 
                  Of Institute/Board/University</font></strong></font></div></td>
              <td width="7%" class="tablecontent1"><div align="center"><strong><font color="#0000CC" size="2" face="Arial, Helvetica, sans-serif">Year of Passing</font></strong></div></td>
              <td width="25%" class="tablecontent1"><div align="center">
                <p><strong><font color="#0000CC" size="2" face="Arial, Helvetica, sans-serif">Subject</font></strong></p>
              </div></td>
              ...
              <td width="9%" class="tablecontent1"><div align="center"><font color="#0000CC"><strong><font size="2" face="Arial, Helvetica, sans-serif">% 
              Of Marks Obtained</font></strong></font></div></td>
              <td width="12%" class="tablecontent1"> <div align="center"><font color="#0000CC"><strong><font size="2" face="Arial, Helvetica, sans-serif">Grade/Division</font></strong></font></div></td>
            </tr>
            <tr>
	...
	?>
          ...
          <p>
           <input type="hidden"  name="eduCount" id="eduCount" value="1">
            <input type="button" name="button"  class="button" id="button" value="Add more" onClick="addRow();"> 
            <strong><font color="#FF0000" size="1"> &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;( * You can add Maximum 6 rows)</font></strong>          
            <input type="button" name="button4"  class="button" id="button4" value="Delete Row" onClick="deleteRowFromEducation();">
          </p></td>
      </tr>
      <tr> 
        ...
        <td height="163" colspan="5"> <font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif"> 
          ...
          <input type="hidden"  name="expCount" id="expCount" value="1">
            <input type="button" name="button"  class="button" id="button" value="Add more" onClick="addRowOnExp();"> 
            <strong><font color="#FF0000" size="1"> &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;( * You can add Maximum 4 rows)</font></strong>          
            <input type="button" name="button3"  class="button" id="button3" value="Delete Row" onClick="deleteRowFromExp();">
          </p></td>
      </tr>
      <tr> 
        <td height="29" colspan="5"> <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr> 
            ...
            <td width="71%" class="tablecontent1"><label>
              <input  name="computer" type="radio" id="computer_1"  onClick="showTable(2);" value="N" checked="CHECKED">
              <font size="2" face="Arial, Helvetica, sans-serif">No</font></label></td> 
            </tr>
        </table></td>
            </tr>
            
            <tr style="display:none" id="compExp"> 
        <td height="127" colspan="5"> <font color="#000033"><strong><font size="2" face="Arial, Helvetica, sans-serif"> 
          </font> </strong> </font> <table id="expComputer" width="100%" height="34" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
          ...
          <input type="hidden"  name="compCount" id="compCount" value="1">
            <input type="button" name="button" class="button" id="button" value="Add more" onClick="addRowOnExpComputer();"> 
            <strong><font color="#FF0000" size="1"> &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;( * You can add Maximum 2 rows)</font></strong>          
            <input type="button" class="button" name="button2" id="button2" value="Delete Row" onClick="deleteRowFromComp();">
          </p></td>
      </tr>
            <tr> 
            ...
            <tr> 
              <td height="90" colspan="5" class="tablecontent2"> <div align="justify"><font color="#000033"><strong><font size="2">I 
...
<div align="center"><span class="link1"><font color="#00a2cf">
       Design and Develped by National Informatics Centre Purba Medinipur West Bengal and Content Provided By District Administration Purba Medinipur
        </font></span>
      </div></td>
</tr>
</table>
