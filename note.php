...
<head>
    ...
    <title>Javascript Enable Note</title>
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="85%">
                            ...
                            <tr>
                                <td><a name="top" id="top"></a><br>
                                    ...
                                    <h3>Internet Explorer 6 and above </h3>
                                    <ul>
                                        <li>1. Select <strong><em>Internet Options</em></strong> from the <span
                                                class="style1"><em>Tools</em> menu. </span></li>
                                        <li>2. In <strong><em>Internet Options</em></strong> dialog box select the
                                            <strong><em>Security</em></strong> tab.
                                        </li>
                                        <li>3. Click the <strong><em>Custom Level...</em></strong> button. The Security
                                            Settings dialog box will pop up.
                                        </li>
                                        <li>4. Under <strong><em>Scripting</em></strong> category enable <strong><em>Active
                                                    scripting</em></strong>.
                                        </li>
                              ...
                              <a name="opera7x" id="opera7x"></a>      <h3>Opera 7.X</h3>
                                    ...
                                    <h3>Mozilla 3.6.X and above</h3>
                                    <ul>
                                        <li>1. Select <em><strong>Options</strong></em> from the
                                            <em><strong>Tools</strong></em> Menu
                                        </li>
                                    ...
                                    <ul>
                                        ...
                                        <li>4. Click on <em><strong>Content Settings</strong></em> under
                                            <em>Privacy</em>.
                                        </li>
                                        <li>5. Check <em><strong>Allow all sites to run JavaScript
                                                    (recommended)</strong></em> under <em>Javascript</em>.
                                        </li>
                                    ...
                                    <strong>Note:</strong> Instructions may vary with different
                                    browsers and operating systems. If you cannot locate the JavaScript
                                    settings, check the help topics for the browser being used.
                                </td>
                            </tr>
                            </tbody>
                        </table>
